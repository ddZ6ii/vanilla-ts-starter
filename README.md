# Vanilla starter - HTML | CSS | TypeScript

This is a starter for vanilla TypeScript projects. It is entended to be used together with `degit` to speed up the workflow of starting a new project from scratch.
